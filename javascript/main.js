class Validator {
    ...
    // começa a validação de todos os campos
    validate(form) {
    ...
    // método para validação de requisito mínimo de tamanho de caracteres
    ...
    // método para validação de tamanho excedido de caracteres
    ...
    // método para validar strings que só possuem letras
    onlyletters(input) {
